...
const docs = {
  flow: [
    ...
    },
    {
      ...
      tips: ['다음 스텝으로 넘어가기를 누르면 현재 스텝의 채점 결과가 저장되고, 현재 스텝을 다시 진행할 수 없어요.',
        '미션으로 돌아가기를 선택하면 원하는 만큼 스텝을 반복해서 진행할 수 있어요.'
      ]
    },
    {
      title: '최종 점수 측정 방식',
      description: '프로젝트의 최종 점수는 이렇게 측정돼요.',
      tips: ['각 스텝들을 완료하면 스텝별로 점수와 평가가 저장돼요.',
        '각 스텝들의 평가 내용과 점수를 종합하여 최종 리포트가 작성돼요.'
      ],
    },
    {
      title: '프로젝트 삭제',
  ...
  issues: [
    {
      title: '리포트가 보이지 않아요.',
      description: '최종 스텝을 완료한 프로젝트에 대한 리포트가 보이지 않나요?',
      tips: [
        '프로젝트의 최종 스텝을 통과하면 자동으로 리포트 생성이 시작됩니다.',
